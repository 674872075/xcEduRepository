...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PIC_NOTEXIST(false,31103,"课程图片不存在!"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31104,"课程发布创建索引发生错误!"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31105,"只允许选择第三级的课程计划关联视频!");
